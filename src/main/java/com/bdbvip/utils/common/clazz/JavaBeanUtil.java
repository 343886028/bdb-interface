package com.bdbvip.utils.common.clazz;
...
public class JavaBeanUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println(JavaBeanUtil.toCamelCaseString(
				"iso_certified_staff", true));
		System.out
				.println(JavaBeanUtil.getValidPropertyName("certified_staff"));
